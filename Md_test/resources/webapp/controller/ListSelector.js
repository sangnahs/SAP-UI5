sap.ui.define([
		...
		return BaseObject.extend("paint.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias paint.model.ListSelector
			 */
			 ...
			 * @return {paint.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
